 ...
 */
package com.cm.cmdc.client.component.usermgmt.vo;

import java.util.Date;

import com.cm.cmdc.framework.client.vo.AbsCommonVo;

/**
 * @Author zhuxiuhong
 * @Since 2018年12月9日 下午9:33:35
 * 
 *        用于查询后 返回的结果.
 */
public class BaseUserVo extends AbsCommonVo {
